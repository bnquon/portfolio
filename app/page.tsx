...
export default function App() {
  ...
  return (
    <main>
      ...
      >
        <div className="w-[60vw] h-fit mt-[8vh] flex flex-col border-b-2 border-[#727272] py-[60px]">
          ...
          <div className="w-1/2 self-end mt-[10vh]">
            <p className="text-3xl leading-[45px] text-white">
              ...
              Computing Science. I am passionate about software engineering,
              will be working on exciting projects at Formations Corp. on a
              Software Engineering Co-op until May 2025. Outside of software, I
        ...
        <div className="w-[60vw] border-b-2 border-[#727272] py-[80px]">
          ...
          {projects.map((project: Project, index) => (
            <div key={index} className="flex mt-[12vh]">
              <div className="box-border w-1/2 flex flex-col text-white pr-10">
